...
app.get("/movies/", async (request, response) => {
  ...
  const getMoviesList = await database.all(getMoviesListQuery);
  response.send(
    getMoviesList.map((eachMovie) => ConvertMovieDbAPI1(eachMovie))
  );
});
...
//Updates the details of movie ID
...
//Returns a list of director table
...
//Returns a list of all director
